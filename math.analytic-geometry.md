...
_задача: найти точку пересечения двух прямых в пространстве_
...
- ${x^2 \over a^2} + {y^2 \over b^2} - {z^2 \over c^2} = -1$ - двуполостный гиперболоид (лень рисовать)
- ${x^2 \over a^2} + {y^2 \over b^2} - {z^2 \over c^2} = 1$ - однополостный гиперболоид (тоже лень рисовать)
  - при сечении плоскостью $y = b$ получается ${x^2 \over a^2} - {z^2 \over c^2} = 0 |\implies (x/a + z / c)(x/a - z/c)=0$, т.е. две прямых
- ${x^2 \over a^2} + {y^2 \over b^2} = 2z$ - эллиптический параболоид
- ${x^2 \over a^2} - {y^2 \over b^2} = 2z$ - гиперболический параболоид

#### Прямые на поверхности гиперболического параболоида

$$
S : x^2 - y^2 = 2z \\
M(x_0, y_0, z_0) \in S \iff x_0^2 - y_0^2 = 2z_0 \\
\Pi : x_0(x - x_0) - y_0(y - y_0) - (z - z_0) = 0\ M \in \Pi \\
\begin{cases}
x^2 - y^2 = 2z \\
x_0(x - x_0) - y_0(y - y_0) - (z - z_0) = 0
\end{cases} \ \\
\iff \begin{cases}
x^2 - y^2 = 2(x_0(x-x_0) - y(y_0 - y) + z_0) \\
x_0(x - x_0) - y_0(y - y_0) - (z - z_0) = 0
\end{cases} \\
x^2 - y^2 = 2xx_0 - 2x_0^2 - 2yy_0 + 2y_0^2 + 2z_0 = 2xx_0 - 2x_0^2 - 2yy_0 + 2y_0^2 + 2z_0 + x_0^2 - y_0^2 \\
\iff \begin{cases}
x^2 - 2xx_0 + x_0^2 - y^2 + 2yy_0 - y_0^2 = 0 \\
x_0(x - x_0) - y_0(y - y_0) - (z - z_0) = 0
\end{cases}
\iff \begin{cases}
(x - x_0)^2 (y - y_0)^2 = 0 \\
...
x_0x - y_0y - z = C
\end{cases} \\
\vec p_1 = \vec n_1 \times \vec n_2 = (-1; 1; -x_0-y_0) \\
l_1 :
\begin{cases}
x = x_0 - t \\
y = y_0 + t \\
z = z_0 - (x_0 + y_0)t,
\end{cases} t \in \R \\
\text{то же самое для второй прямой} \\
(x_0 - t)^2 - (y_0 + t)^2 =? 2(z_0 - (x_0 + y_0)t) \\
x_0^2 -2x_0t + t^2 - (y_0^2 + 2y_0t + t^2) =? 2(z_0 - (x_0 + y_0)t) \\
x_0^2 - y_0^2 = 2z_0 \\
\text{опять то же самое для второй прямой}
$$

#### Цилиндрические поверхности

Цилиндрическая поверхность задаётся направляющей кривой и прямой; через каждую точку направляющей кривой проводится прямая, параллельная данной

- ${x^2 \over a^2} + {y^2 \over b^2} = 1$ - эллиптический цилиндр
- ${x^2 \over a^2} - {y^2 \over b^2} = 1$ - гиперболический цилиндр
- $y^2 = 2px$ - параболический цилиндр

#### Особые поверхности

- $(A_1x + B_1y + C_1z + D_1)(A_2x + B_2y + C_2z + D_2)$ - пара плоскостей
- $x^2 + y^2 = 0$ - прямая
- ${x^2 \over a^2} + {y^2 \over b^2} + {z^2 \over c^2} = 0$ - точка
- ${x^2 \over a^2} + {y^2 \over b^2} - {z^2 \over c^2} = 1$ - $\emptyset$

## Проективная плоскость

Рассмотрим $\R^3 : x_0, x_1, x_2$  
$x_0 \neq 0 \implies (x_0, x_1 x_2) \to (1; {x_1 \over x_0}; {x_2 \over x_0})$ - координаты в проективном пространстве
$x_0 = 0$ - бесконечно удалённая прямая
